...
(function () {
  ...
  var headerHtml =
    ...
    '<i class="bi bi-envelope d-flex align-items-center"><a href="mailto:admin@yjselect.com">admin@yjselect.com</a></i>' +
  ...
  var footerHtml =
    ...
    "<p><strong>대표번호 :</strong> 031-457-9286 &nbsp;|&nbsp; <strong>Email :</strong> admin@yjselect.com</p>" +
